    ...
    <div class="row">
        <div class="col-md-8 offset-md-2">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('pedido.procesarPedidos')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
              ...
              <div class="card-item__content">
                  ...
                  <transition name="slide-fade-up">
                    <div class="card-item__name" v-if="cardName.length" key="1">
                      <transition-group name="slide-fade-right">
                        <span class="card-item__nameItem" v-for="(n, $index) in cardName.replace(/\s\s+/g, ' ')" v-if="$index === $index" v-bind:key="$index + 1"><?php echo e(n); ?></span>
                      </transition-group>
                    </div>
                ...
                <div class="card-item__date" ref="cardDate">
                  ...
                  <label for="cardMonth" class="card-item__dateItem">
                    <transition name="slide-fade-up">
                      <span v-if="cardMonth" v-bind:key="cardMonth"><?php echo e(cardMonth); ?></span>
                  ...
                  <label for="cardYear" class="card-item__dateItem">
                    <transition name="slide-fade-up">
                      <span v-if="cardYear" v-bind:key="cardYear"><?php echo e(String(cardYear).slice(2,4)); ?></span>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Juan\Documents\Mis archivos\web_libre\proyecto_php\Restaurante_Web\resources\views/pago/index.blade.php ENDPATH**/ ?>