...
.vintage-table tfoot {
    background-color: #f5e8c0;
    /* Color de fondo para la fila de pie de tabla */
}

.vintage-table tfoot td {
    font-weigh .text-center {
        text-align: center;
    }


    t: bold;
    /* Texto del pie de tabla en negrita */
}
</style>


<div class="container">
    <h1 class="vintage-text my-5">Pedido de <?php echo e($pedidos->nombre_cliente); ?></h1>
    <h2 class="vintage-text">Fecha de Pedido: <?php echo e($pedidos->fecha_pedido); ?></h2>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Juanjo\Documents\MisArchivos\Gestion\Proyecto\BonHouse\resources\views/Admin/DetallePedido.blade.php ENDPATH**/ ?>